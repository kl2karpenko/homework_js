...
Замените в строке все буквы "l" на букву "a", удалите из строки 5 и 7 символ, проверте правильность замены ( то есть проверте есть ли в замененной строке буква "l" ), присвойте результат текущей переменной и выведете ее через alert:
